...
#define   _____________________RAISE_L3_______________________ KC_LCTL, KC_CALC, KC_VOLD, KC_MPRV,  KC_BRIU,  KC_BRID
...
/* ------------------------------------------------------------COL1------COL2-----COL3-----COL4-----COL5-----COL6--------- */
#define   _____________________LOWER_L1_______________________ KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5
#define   _____________________LOWER_L2_______________________ KC_LSFT,  XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, KC_PGDN
#define   _____________________LOWER_L3_______________________ KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5
